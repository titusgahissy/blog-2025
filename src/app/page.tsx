  ...
  return (
    <Container className="pt-12 md:pt-8 xl:pt-24 space-y-3 md:space-y-4 xl:space-y-6">
      ...
      <div className="text-xl md:text-4xl xl:text-5xl/13 font-normal ">
        Hello, I'm <span className="font-medium">Titus Gahissy</span>.<br />I explore not so boring ideas and<br />challenge teams and founders to bring more value to users.
      </div>
      <div className="text-ld md:text-2xl xl:text-3xl text-neutral-500 font-normal">
