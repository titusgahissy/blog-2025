...
const Albums = () => (
  <div className="pt-16 flex flex-col gap-4 md:gap-12  divide-y divide-neutral-300 dark:divide-neutral-700">
    ...
    <Album album="colombia" title="Colombia" description="Bogota, Santa Marta,Cartagena,Medellin" images="3,7,8,4,9,10,12,13,14,16,17,19,20,22,23,24,25,26,28,29,30" />
