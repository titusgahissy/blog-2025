...
Courses and Workshops might be the reason I'm going to commit with this version of the site longer. I do spend a lot of time with teams or various size, teaching how to build better software and products. People have been asking for years now for a way to stay informed of the coming courses and workshops. So, this year, I'm giving it a shot.

This addition represents the most significant difference between this iteration and previous attempts. There's now a practical purpose beyond self-expression, a reason to maintain consistent engagement with this digital space. It's no longer just about when inspiration strikes for a blog post-it's about creating reliable value for professionals looking to enhance their skills.

These educational offerings will cover topics ranging from architectural decision-making frameworks to product development methodologies, from technical leadership principles to practical implementation strategies. They'll vary in format and depth, including everything from concise webinars addressing specific challenges to comprehensive multi-day workshops exploring complex concepts.

What excites me most about incorporating this educational element is the potential for community building. Each session creates connections-between concepts, between participants, and between theory and practice. These connections inevitably generate new ideas worth exploring on the blog, creating a virtuous cycle of content that might finally break my two-year abandonment pattern.
